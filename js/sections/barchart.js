// funcion para crear barcharts en vegalite
        ...
        "vconcat": [{
            ...
            "encoding": {
              "x": {
                ...
                "axis": {
                  "title": "Monto contratación familiares (en millones de pesos)"
                }
              },
              "color": {
                "condition": {
              ...
              "tooltip": [{
                ...
                {
                  "field": "periodos_electos",
                  "type": "nominal",
                  "title": "Años en el congreso:"
                },
                {
                  "aggregate": "sum",
                  "field": "valor_total_contratos",
                  "type": "quantitative",
                  "format": "$,",
                  "title": "Monto contratación familiares:"
                },
                {
                  "aggregate": "sum",
                  "field": "numero_contratos",
                  "type": "quantitative",
                  "title": "Número contratos:"
                }
              ]
            },
            "selection": {
            ...
            "hconcat": [{
              ...
              "encoding": {
                "x": {
                  ...
                  "format": ",",
                  "axis": {
                    "title": "Monto contratación (en millones de pesos)"
                  }
                },
                "tooltip": [{
                    "field": "Congresista",
                ...
                "y": {
                  ...
                  "axis": {
                    "title": "Familiar o Empresa familiar"
                  },
                  "color": {
                    "condition": {
                      "selection": "familiaresel",
                      "value": "orange"
                    },
                    "value": "#550F3F"
                  },
        ...
        "vconcat": [{
            ...
            "encoding": {
              ...
              "x": {
                ...
                "type": "quantitative",
                "axis": {
                  "title": "Número de familiares o empresa familiar"
                },
                "scale": {
                  "type": "linear"
                }
